...
RUBRIC_RH = os.path.join(source_dir, 'rubric', 'rh.config')
...
P4 = cs_grading.Problem(HOMEWORK, 3, 'llrec', 13)
P5 = cs_grading.Problem(HOMEWORK, 4, 'stack', 2)
P6 = cs_grading.Problem(HOMEWORK, 7, 'heap', 18)
P7 = cs_grading.Problem(HOMEWORK, 8, 'rh', 25)
for problem, rubric in [(P4, RUBRIC_LLREC), (P5, RUBRIC_STACK), (P6, RUBRIC_HEAP), (P7, RUBRIC_RH)]:
