...
RUBRIC_LABEL = os.path.join(source_dir, 'rubric', 'label.config')
...
#P6 = cs_grading.Problem(HOMEWORK, 6, 'str', 29)
P5 = cs_grading.Problem(HOMEWORK, 6, 'label', 38)
for problem, rubric in [(P5, RUBRIC_LABEL)]: #[(P1, RUBRIC_LOGIN), (P2, RUBRIC_HEAP), (P3, RUBRIC_RECS)]:
